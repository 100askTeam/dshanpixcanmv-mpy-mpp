...
#if defined(CONFIG_MPP_DSI_ENABLE_LCD_AML020T)
    {
        // this configure is generated by tools.
        .connector_name = "aml020t", // maybe should change it
        .screen_test_mode = 0,
        .dsi_test_mode = 0,
        .bg_color = BACKGROUND_BLACK_COLOR,
        .intr_line = 10, // 1024 lines
        ...
        .phy_attr = {
            ...
            .m = 295,
            .voc = 0x17, // 0b00010111
            .hs_freq = 0x80 | 0x16, // 0b10100110
        },
        .resolution = {
            .pclk = 11760, // 39600 * 1000 / (480 + 8 + 40 + 40) / (640 + 200 + 10 + 260) = 62.81 fps
            .phyclk = 445500,
            .htotal = (480 + 2 + 16 + 50), 
            .hdisplay = 480,
            .hsync_len = 2,
            .hback_porch = 16,
            .hfront_porch = 50,
            .vtotal = (360 + 60 + 180 + 60), // 1110
            .vdisplay = 360,
            .vsync_len = 5,
            .vback_porch = 20,
            .vfront_porch = 5,
        },
        .type = AML020T_MIPI_2LAN_480X360_30FPS, // maybe should change it
    },
#endif
    {
        .connector_name = NULL,
